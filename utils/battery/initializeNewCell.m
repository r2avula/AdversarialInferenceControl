...
cellSimParams.soc = mphglobal(model,'SOCcell','dataset','dset2','solnum','end');
cellSimParams.terminal_voltage = mphglobal(model,'Ecell','dataset','dset2','solnum','end');
cellSimParams.internal_resistance = mphglobal(model,'R_cell_int','dataset','dset2','solnum','end');
...
% cellSimParams.soc_at_load = cur_soc_at_load;
% cellSimParams.soc_3c = cur_soc_3c;

cellSimParams.cellsIterated = cellSimParams.cellsIterated + 1;
cellSimParams.relativeCapacity = 100;
