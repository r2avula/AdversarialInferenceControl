function [optimalControlData] = simulate_BEM_FDC(evalParams, pp_data)
...
worketData = struct;
worketData.env = env;
worketData.P_UkgYckn1Idx = pp_data.P_UkgYckn1Idx;
...
%% Supporting functions
    ...
    function [mean_correct_detection_, bayesian_reward_, mean_PYkgY12kn1, estimatedhypStateData_, modifiedSMdata_, auxdata, Y_kn1_idx] =...
        ...
        P_UkgYckn1Idx = worketData.P_UkgYckn1Idx;
